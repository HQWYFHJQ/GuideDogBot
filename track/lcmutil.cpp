...
void lcmUtil::send(float v_des[3],int gait_type,float step_height,float stand_height,float rpy_des[3]){
    ...
    ctl.rpy_des[0]=rpy_des[0];//rpy_des[0](横滚角roll)
    ctl.rpy_des[1]=rpy_des[1];//rpy_des[1](俯仰角pitch)
    lcm1.publish("robotctrl",&ctl);
}
